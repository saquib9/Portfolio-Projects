# COVID-19 Global Data Exploration - MySQL

This project focuses on analyzing data related to the COVID-19 pandemic using SQL queries. I worked with a dataset that provides information about COVID-19 cases, deaths, population, and vaccinations across different locations and continents. The main objective is to gain valuable insights and answer important questions about the pandemic.

Data Source: https://ourworldindata.org/covid-deaths

I used SQL queries to address different aspects of the COVID-19 data. Below is a summary of the queries and the insights they provide:
